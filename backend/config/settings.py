...
# Database
# This will be overridden in settings_test.py and settings_database.py
DATABASES = {
    'default': {
...
USE_TEST_MODE = os.environ.get('USE_TEST_MODE', 'False') == 'True'
GENERATE_FIXTURES = os.environ.get('GENERATE_FIXTURES', 'False') == 'True'
